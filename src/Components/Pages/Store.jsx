      ...
      <div className="bannergame eldenringinfo">
        <div className="left">
          <div className="eldenring">
            ...
            <div className="info">
              <p>
                Batman: Arkham Knight is the latest action-adventure game from Rocksteady Studios,<br/> the creators of the Batman: Arkham series. In this epic conclusion to the Arkham trilogy, <br/> you must become the Dark Knight and save Gotham City from Scarecrow and his army of <br/> Arkham Knight soldiers. With its stunning visuals, fluid combat, and gripping story, <br/> Batman: Arkham Knight is a must-play for fans of the Dark Knight.
              </p>
            </div>
          </div>
