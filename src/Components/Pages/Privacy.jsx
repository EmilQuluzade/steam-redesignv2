...
const Privacy = () => {
  return (
    <div className="privacy">
        <div className="rules">
            <h1>PRIVACIY AND POLICY</h1>
            <p>Valve respects the privacy of its online visitors and customers of its products and services and complies with applicable laws for the protection of your privacy, including, without limitation, the California Consumer Privacy Act ("CCPA"), the European Union General Data Protection Regulation ("GDPR") and the UK GDPR.
...
Revision Date: January 1, 2023</p>
        </div>
    </div>
  )
}
